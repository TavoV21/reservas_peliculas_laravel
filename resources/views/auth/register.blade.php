    ...
    <div class="card-body">
        <form id="frmregister" method="POST" action="">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="name" class="form-control" placeholder="Ingresar su nombre">
            </div>
            ...
            <div class="input-group mb-3">
              ...
              <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Comfirmar contraseña">
            </div>
